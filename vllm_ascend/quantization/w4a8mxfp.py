...
class AscendW4A8MXFPDynamicLinearMethod:
    """Linear method for Ascend W4A8_MXFP.
    """
    model_dtype = None
    ...
    def apply(
        ...
        pertoken_scale = dynamic_scale.reshape(dynamic_scale.shape[0], -1)
...
class AscendW4A8MXFPDynamicFusedMoEMethod:
    ...
    def process_weights_after_loading(self, layer):
        layer.w13_weight.data = torch_npu.npu_format_cast(layer.w13_weight.data.to(torch.float32), 29, torch.float8_e4m3fn)
